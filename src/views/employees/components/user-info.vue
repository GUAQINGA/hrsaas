    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <image-upload ref="personnelPhoto"></image-upload>
        </el-form-item>
  ...
  methods: {
    ...
    async getPersonalInfo() {
      ...
      if (this.formData.staffPhoto && this.formData.staffPhoto.trim()) {
        this.$refs.personnelPhoto.fileList = [
    ...
    async savePersonal() {
      const fileList = this.$refs.personnelPhoto.fileList
      await updatePersonalInfo({
        ...this.formData,
        staffPhoto: fileList.length ? fileList[0].url : ' '
      })
      this.$message.success('更新员工个人信息成功')
    }
  }
}
</script>
